...
export AWS_USER_PROFILE=main
export AWS_2AUTH_PROFILE=default
export ARN_OF_MFA=arn:aws:iam::085172126174:mfa/iphone16e
...
echo
echo "great, you now might want to run 'dev docker-login'"
